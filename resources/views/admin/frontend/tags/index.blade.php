...
@section('content')
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <i class="bi bi-plus-lg me-1"></i> Create Tags
</a>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="text-center">
          <a href="{{ route('admin.tags.edit', $tags->id) }}" class="btn btn-sm btn-warning">Edit</a>
          <form action="{{ route('admin.tags.destroy', $tags->id) }}" method="POST" class="d-inline delete-form">
    @csrf
