        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    ...
                    <h5 class="card-title fw-semibold mb-4">Policies</h5>
                    <div class="card">
                        <div class="card-body">
                            <a href="{{ route('admin.policy.create') }}" class="btn btn-success mb-3">
                                <i class="bi bi-plus-lg me-1"></i> Create Policy
                            </a>

                            <div class="table-responsive">
                                <table id="policyTable" class="table text-nowrap align-middle mb-0">
                                    <thead>
                                        ...
                                        @foreach($policies as $index => $policy)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="{{ route('admin.policy.edit', $policy->id) }}" class="btn btn-sm btn-warning">Edit</a>

                                                    <form action="{{ route('admin.policy.destroy', $policy->id) }}" method="POST" class="d-inline delete-form">
                                                        @csrf
