...
$(document).ready(function () {
    ...
    function updateUrlParameters(params) {
        ...
        const keys = ['sub_category_id', 'tags[]', 'availability', 'min_price', 'max_price', 'sort_by', 'per_page', 'grid_mode', 'filter'];
        keys.forEach(key => url.searchParams.delete(key));
        
        if (params.sub_category_id) url.searchParams.set('sub_category_id', params.sub_category_id);
        ...
        if (params.grid_mode) url.searchParams.set('grid_mode', params.grid_mode);
